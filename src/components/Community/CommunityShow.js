...
const PartnerShows = () => {
  ...
  useEffect(() => {
    ...
    } else if (parsed.community_id) {
      service.getCommunityShow(parsed.community_id).then((response) => {
        if (response.err === "No partners found") {
          history.goBack();
        } else {
          setPartnerDetails(response.data);
        ...
        <div className="topContainer">
          <div className="menuCloseJS closeMenuWrapper">
            <div className="moviePageWrapper">
              {partnerDetails.community_image && (
                <div
                  className="moviePageBG" style={{
                    backgroundImage: `url(${
                      imageUrl + partnerDetails.community_image
                    })`,
                  }}
                    ...
                    <div className="row vp3Section">
                      <div className="col col-5-5">
                        <div className="vpLeftSection partnerDetailLeftSection">
                          {partnerDetails.community_image && (
                            <div
                              className="vpPoster partnerDetailProfilePic"
                              style={{
                                backgroundImage: `url(${
                                  imageUrl + partnerDetails.community_image
                                })`,
                        ...
                        <div className="vpMiddleHeading">
                          {partnerDetails.community_name && (
                            <h1
                              className="vpMiddleh1"
                        ...
                        {partnerDetails.community_description && (
                          <div className="vpMiddleDesc partnerMiddleDesc">
                            {partnerDetails.community_description}
                          </div>
                        )}
                          ...
                          partnerCategory.map((item, index) => {
                            return (
                              <div
                                ...
                                className={
                                  index === 0
                                    ? "row vp3Section youMayLike"
                                    : "row vp3Section youMayLike borderpartner"
                                }
                              >
                                <div className="col">
                                  <div>
            ...
            <div className="moviePageWrapper">
              {partnerDetails.partner_image && (
                <div
                  ...
                  style={{
                    backgroundImage: `url(${
                      imageUrl + partnerDetails.partner_image
                    })`,
                  }}
                ></div>
              )}
                  ...
                  <div className="container vpContainer">
                    <div className="row vp3Section">
                      <div className="col col-5-5">
                        ...
                        {partnerDetails.partner_description && (
                          <div className="vpMiddleDesc partnerMiddleDesc">
                            {partnerDetails.partner_description}
                          </div>
                        )}
