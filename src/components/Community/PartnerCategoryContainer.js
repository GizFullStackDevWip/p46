                                ...
                                <div className="movieTileImage" className={hover === true && focusedId === index ? "movieTileImage movieTileImageOpen" : "movieTileImage"} id={index}
                                    ...
                                    <div onClick={() => { functionOnclick(show) }} className={hover === true && focusedId === index ? "movieTileIcon " : "movieTileIcon  movieTileHoverOpened"}>
                                        {hover === true && focusedId === index ?
                                            <svg className="svgIcon movieTilePlayIcon" preserveAspectRatio="xMidYMid meet" viewBox="0 0 62 62" style={{ color: 'white' ,fill: 'currentcolor' }} onClick={() => { functionOnclick(show) }}>
                                ...
                                <section className="movieTextWrapper movieTextWrapperPadding">
                                    <div className="movieTextFlex">
                                        <h3>
                                            {
                                                show.video_title &&
                                                <a className="linkButton movieTextHeading" style={{display:"flex"}} onClick={() => { functionOnclick(show) }}>{show.video_title}</a>
                                            }
                                        </h3>
