                                            ...
                                            <div id="registerId">
                                                ...
                                                <form className="regnformContainer" noValidate onSubmit={onSubmitHandler}>
                                                    ...
                                                    <div className={"input" + password}>
                                                        <input className="inputText" name="password" value={values.password} onChange={onChangeHandler} />
                                                    ...
                                                    <div className="regnAgreeContent">
                                                        <p>By registering, you agree to Tubi's <div className="linkButton" href="#">Term of Use</div> and
