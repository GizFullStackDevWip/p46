                        ...
                        <div className="col col-4 col-lg-3 col-xl-1-5 col-xxl-2 socialTray">
                            <div className="socialLinkContainer">
                                <div className="footerSLWrapper">
                                    <a href="https://www.facebook.com/GetHappiTV" rel="noopener" target="_blank" className="linkButton footerFacebook">
                                    ...
                                    <a href="https://www.instagram.com/gethappitv/?fbclid=IwAR0kCEbOZR5ZinmfFLEhTP41ru-e13CymopaHsb4De3WQqyM40wgGpmvu9s" rel="noopener" target="_blank" className="linkButton footerInsta">
                                    ...
                                    <a href="https://twitter.com/gethappitv?fbclid=IwAR1788x80QtFqAhRrWP-FHrPisVdKDlIZ3cI76A3PvkU75TKCIXa8JBf4lI" rel="noopener" target="_blank" className="linkButton footerTwitter">
                    ...
                    <div className="row footerMenu" style={{ lineHeight: '1.4rem' }}>
                        <div className="col col-4 col-lg-3 col-xl-1-5 col-xxl-2">
                            <ul className="footerMenuContainer">
                                ...
                                <li> <div style={{ color: '#fff' }}
                                    onClick={() => { functionOnclick('/aboutus') }} rel="noopener" target="_self" className="linkButton">About Us</div></li>
                                {/* <li> <a rel="noopener" target="_self" className="linkButton">Careers</a></li> */}
                                <li><div style={{ color: '#fff' }} rel="noopener" target="_self"
                                    onClick={() => { functionOnclick('/contactus') }} className="linkButton">Contact</div></li>
                            </ul>
                        </div>
                        <div className="col col-4 col-lg-3 col-xl-1-5 col-xxl-2">
                            <ul className="footerMenuContainer">
                                ...
                                <li><div style={{ color: '#fff' }} className="linkButton"
                                    onClick={() => { functionOnclick('/contactsupport') }} >Contact Support</div></li>
                        ...
                        <div className="col col-4 col-lg-3 col-xl-1-5 col-xxl-2">
                            <ul className="footerMenuContainer">
                                ...
                                <li ><div style={{ color: '#fff' }} className="linkButton"
                                    onClick={() => { functionOnclick('/contactsupport') }} >Partner with Us</div>
                                </li>
                            </ul>
                        </div>
                        <div className="col col-4 col-lg-3 col-xl-1-5 col-xxl-2">
                        ...
                        <div className="col col-4 col-lg-3 col-xl-1-5 col-xxl-2">
                            <ul className="footerMenuContainer">
                                ...
                                <li><div style={{ color: '#fff' }}
                                    onClick={() => { functionOnclick('/termsandconditions') }} className="linkButton" >Terms of Use (Updated)</div></li>
                                {/* <li><div style={{ color: '#fff' }} className="linkButton"
