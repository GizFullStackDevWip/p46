  ...
  return (
    <div className="footerInfo">
      <div className="footerApps">
        <a
          // href="https://apps.apple.com/in/app/boondock-nation/id1448300263"
          href="#"
          // target="_blank"
        >
          <span rel="noopener" target="_blank" className="linkButton">
            <svg
              locale="[object Object]"
              className="svgIcon appStoreApple"
              preserveAspectRatio="xMidYMid meet"
              viewBox="0 0 119.66 40"
              style={{ fill: "rgb(32, 32, 38)" }}
            >
              <path
              ...
              <g dataname="<Group>">
                <g dataname="<Group>">
                  <g fill="#fff" dataname="<Group>">
                    <path
                      d="m24.769 20.301a4.9488 4.9488 0 0 1 2.3566-4.1521 5.0657 5.0657 0 0 0-3.9912-2.1577c-1.6792-0.17626-3.3072 1.0048-4.1629 1.0048-0.87227 0-2.1898-0.98733-3.6085-0.95814a5.3153 5.3153 0 0 0-4.4729 2.7279c-1.934 3.3484-0.49141 8.2695 1.3612 10.976 0.9269 1.3254 2.0102 2.8058 3.4276 2.7533 1.3871-0.05753 1.9051-0.88448 3.5794-0.88448 1.6588 0 2.1448 0.88448 3.591 0.8511 1.4884-0.02416 2.4261-1.3312 3.3205-2.6691a10.962 10.962 0 0 0 1.5184-3.0925 4.782 4.782 0 0 1-2.9192-4.3992z"
                      dataname="<Path>"
                    ></path>
                    <path
                      d="m22.037 12.211a4.8725 4.8725 0 0 0 1.1145-3.4906 4.9575 4.9575 0 0 0-3.2076 1.6596 4.6363 4.6363 0 0 0-1.1437 3.3614 4.099 4.099 0 0 0 3.2368-1.5304z"
                      dataname="<Path>"
                    ></path>
                  </g>
                </g>
        ...
        <a
          // href="https://play.google.com/store/apps/details?id=com.discovermediaworks.boondocktemplate"
          // target="_blank"
          href="#"
        >
          <span rel="noopener" target="_blank" className="linkButton">
            <svg
              locale="[object Object]"
              className="svgIcon appStoreGoogle"
              preserveAspectRatio="xMidYMid meet"
              viewBox="0 0 180 53.3"
              style={{ fill: "rgb(32, 32, 38)" }}
            >
                ...
                <g id="g12" transform="scale(.1)">
                  ...
                  <g id="g50">
                    ...
                    <g id="g52" clipPath="url(#SVGID_2_)">
                      <linearGradient
                        ...
                        x2="-18810.891"
                        y2="-21267.199"
                        gradientTransform="scale(-4.2194) rotate(45 -34956.32 11951.093)"
                      >
                  ...
                  <g id="g74">
                    <defs>
                      <path
                        id="SVGID_3_"
                        d="M270 357.2l.9.5 48.9 27.8c4.7 2.7 7.8 5.9 9.3 9.3-1.5-3.4-4.7-6.6-9.3-9.3l-48.9-27.8-.9-.5m0 1.5L228.8 400l41.3 41.3L320 413c6.3-3.6 9.9-8.2 10.5-13-.6-4.7-4.1-9.4-10.5-13l-50-28.3"
                      ></path>
                    </defs>
                    ...
                    <g id="g76" clipPath="url(#SVGID_4_)">
                      <linearGradient
                        ...
                        x2="-20001.412"
                        y2="-21661.736"
                        gradientTransform="rotate(180 -42853.031 -46391.445) scale(4.3017)"
                      >
                  ...
                  <g id="g94">
                    <defs>
                      <path
                        id="SVGID_5_"
                        d="M113.6 271.4c-3.5 0-6.5 1.1-8.8 3.2 2.4-2.1 5.4-3.2 8.8-3.2h.9-.9m0 1.5c-3.5 0-6.5 1.1-8.8 3.2l124 123.9 41.3-41.3-145.2-82.5c-4.1-2.3-7.9-3.3-11.3-3.3m-8.8 1.8l-.6.6.6-.6"
                      ></path>
                    </defs>
                    ...
                    <g id="g96" clipPath="url(#SVGID_6_)">
                      <linearGradient
                        ...
                        x2="-18852.475"
                        y2="-21699.688"
                        gradientTransform="scale(-5.7218) rotate(45 -35562.742 11823.155)"
                      >
                  ...
                  <g id="g110">
                    <defs>
                      <path
                        id="SVGID_7_"
                        d="M228.8 400l-124 123.9c2.4 2.1 5.4 3.2 8.8 3.2 3.4 0 7.2-1.1 11.2-3.4L270 441.2 228.8 400m42.2 42.2l-146.1 83c-4 2.3-7.8 3.4-11.2 3.4h.1c3.4 0 7.2-1.1 11.2-3.4l146-83m-157.5 86.4"
                      ></path>
                    </defs>
                    ...
                    <g id="g112" clipPath="url(#SVGID_8_)">
                      <linearGradient
                        ...
                        x2="-16250.162"
                        y2="-23175.293"
                        gradientTransform="scale(2.555) rotate(-45 20145.964 -31121.24)"
                      >
                  ...
                  <path
                    id="path132"
                    d="M114.6 271.4c3.1.2 6.6 1.3 10.3 3.3L270 357.2l-145.1-82.5c-3.7-2-7.2-3.1-10.3-3.3m-9.8 3.2c0 .1 0 0 0 0m-.7.7"
                  ></path>
                  <g id="g134">
                    <defs>
                  ...
                  <g id="g154">
                    <defs>
                      <path
                        id="SVGID_11_"
                        d="M113.6 271.4c-3.5 0-6.5 1.1-8.8 3.3l-.6.6-.1.1.7.7c2.4-2.1 5.4-3.3 8.8-3.2 3.4 0 7.2 1.1 11.2 3.4L270 358.8l.9-.9-.9-.5-145.1-82.5c-3.7-2.1-7.1-3.2-10.3-3.3-.4-.2-.7-.2-1-.2"
                      ></path>
                    </defs>
                  ...
                  <path
                    id="path170"
                    d="M104.1 275.4c-2.9 3.1-4.6 7.9-4.6 14.1-.1-6.3 1.6-11.1 4.6-14.1"
                  ></path>
                  <g id="g172">
                    <defs>
                      <path
                        id="SVGID_13_"
                        d="M104.1 275.4c-2.9 3.1-4.6 7.9-4.6 14.1v1.5c0-6.2 1.7-11 4.6-14.1l.7-.7-.7-.8"
                      ></path>
                    </defs>
                  ...
                  <path
                    id="path212"
                    d="M329.3 394.8c.8 1.7 1.2 3.4 1.2 5.2-.1-1.8-.5-3.5-1.2-5.2"
                  ></path>
                  <g id="g214">
                    <defs>
                      <path
                        id="SVGID_17_"
                        d="M271 357.8l-.9.9L320 387c6.3 3.6 9.9 8.2 10.5 13 0-1.7-.4-3.5-1.2-5.2-1.6-3.4-4.7-6.6-9.3-9.3l-49-27.7"
                      ></path>
                    </defs>
                  ...
                  <path
                    id="path234"
                    fill="#404040"
                    d="M330.4 400c0 5.2-3.5 10.5-10.5 14.4L271 442.2l48.9-27.8c7-3.9 10.5-9.2 10.5-14.4"
                  ></path>
                  <g id="g236">
                    <defs>
                      <path
                        id="SVGID_19_"
                        d="M330.4 400c-.6 4.7-4.1 9.4-10.5 13L270 441.3l.9.9 48.9-27.8c7.1-3.9 10.6-9.2 10.6-14.4"
                      ></path>
                    </defs>
                  ...
                  <path
                    id="path256"
                    fill="#404040"
                    d="M99.5 512.2c0 .1 0 .1 0 0 0 .1 0 .1 0 0m0 .2c.6 10.3 6.2 16.2 14.1 16.2-3.4 0-6.4-1.1-8.7-3.2l-.7-.7c-2.8-2.9-4.4-7-4.7-12.3"
                  ></path>
                  <g id="g258">
                    <defs>
                      <path
                        id="SVGID_21_"
                        d="M99.4 509.1v3.2c.3 5.3 2 9.5 4.6 12.3l.7-.7c-3.3-3-5.3-8.1-5.3-14.8m5.4 16.2"
                      ></path>
                    </defs>
                  ...
                  <path
                    id="path282"
                    fill="#404040"
                    d="M113.5 528.6s.1 0 0 0c.1 0 0 0 0 0"
                  ></path>
                  <g id="g284">
                    <defs>
                      <path
                        id="SVGID_23_"
                        d="M270 441.3l-145.1 82.5c-4 2.3-7.8 3.4-11.2 3.4-3.5 0-6.5-1.1-8.8-3.2l-.7.7.7.7c2.3 2.1 5.3 3.2 8.7 3.2 3.4 0 7.2-1.1 11.2-3.4l146.1-83-.9-.9"
                      ></path>
                    </defs>
      ...
      <div className="footerCopyText">
          <div>Copyright &copy; 2022 Project forty-six</div>
          <div> All Rights Reserved. All content uploaded to this platform are owned by the content creator with user rights expressed to project forty six. Duplication of content is prohibited unless authorized by the content creator.</div>
        </div>
      </div>
    </div>
  );
