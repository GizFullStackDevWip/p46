            ...
            <div className="container headerWrapper">
                ...
                <div className="headerButton">
                    <div className="loginButtonContainer">
                        <ul>
                            <li><a className="headerSignInButton" href="/register">Register</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div className="row signWrapper">
                            <div className="col col-9 col-lg-6 col-xl-6 col-xxl-4">
                                ...
                                <div>
                                    ...
                                    <form className="signFormWrapper" noValidate="" method="POST">
                                        <div className="input">
                                            <input className="inputText" name="email" type="email" autoComplete="email" />
                                            <span className="inputLabel">Email</span>
                                        </div>
                                        <div className="input">
                                            <input className="inputText" name="password" type="password" autoComplete="password" />
                                        ...
                                        <div className="signAgree">
                                            <p><a className="linkButton" href="/forgot">Forgot password?</a> <span>·
                                                </span> Don't have an account? <a className="linkButton" href="/signup">Register</a>
                                            </p>
                                        </div>
                                    </form>
                                </div>
