                    ...
                    <div className="entry-content">
                      ...
                      {/* <div id="half-page-position" className="vc_row wpb_row vc_row-fluid vc_custom_1596013627396 bb_custom_1596013627397">
												<div className="wpb_column vc_column_container vc_col-sm-12">
													<div className="vc_column-inner">
														<div className="wpb_wrapper">
															<div className="wpb_text_column wpb_content_element  normal w_780  vc_custom_1581604390850 container discover-content">
																<div className="wpb_wrapper">
                      ...
                      {/* <div className="vc_row wpb_row vc_row-fluid">
												<div className="wpb_column vc_column_container vc_col-sm-12">
													<div className="vc_column-inner">
														<div className="wpb_wrapper">
															<div className="discover-service-list-wrapper ">
																<div className="wpb_text_column wpb_content_element  small w_870 b-border  leadership container discover-service-list">
																	<div className="wpb_wrapper">
																		<div className="service-item "> <img src={require("../../../images/aboutus/new.jpg")} alt="" style={{ width: '100%' }} />
																			<div>
																				...
																				<span>Daniel@staging.discovermediaworks.com</span>
																			</div>
																		</div>
																		<div className="service-item "> <img src={require("../../../images/aboutus/new.jpg")} alt="" style={{ width: '100%' }} />
																			<div>
																				...
																				<span>Daniel.berilla@staging.discovermediaworks.com</span>
																			</div>
																		</div>
																		<div className="service-item "> <img src={require("../../../images/aboutus/new.jpg")} alt="" style={{ width: '100%' }} />
																			<div>
																				...
																				<span>Rafael@staging.discovermediaworks.com</span>
																			</div>
																		</div>
																	</div>
																</div>
													...
													<div className="vc_column-inner">
														<div className="wpb_wrapper">
															<div className="wpb_text_column wpb_content_element    container discover-footer">
																<div className="wpb_wrapper">
																	<hr />
																	<p>The provided agreements on Boondock Nation are for informational purposes only and do not constitute legal advice.</p>
																</div>
															</div>
														</div>
													</div>
