...
const Movies = ({ }) => {
    ...
    console.log('moviesparsed', parsed)
                    ...
                    <div className="videoPage" >
                        ...
                        <div itemProp="video" itemScope="" itemType="//schema.org/VideoObject" style={{ display: 'none' }}>
                            ...
                            <span property="media:type" content="application/x-shockwave-flash">
                                ...
                                <meta itemProp="thumbnailUrl" rel="media:thumbnail" content="https://canvas-bridge02.happitv.com/TqhXytttTFksHhwcrb4GXqvcle0=/0x156:1000x713/640x360/smart/img.adrise.tv/617cbb9f-c81f-47d2-94f4-8fb757d352fe.jpg" />
