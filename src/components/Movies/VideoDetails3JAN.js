...
const VideoDetails = (categoryId, episode) => {
      ...
      if (videoDetails.length == 0) {
        ...
        service.userSubscription(uId).then((useResponse) => {
          ...
          if (useResponse.login_needed) {
            alert("Sorry!! Your session has expired please SignIn to continue...")
            history.push({
              pathname: "/signin",
            });
          }
  ...
  return (
    ...
    //                                   }}
    //                                 >
    //                                    { show.is_free_video == false && <img src={premium} style={{position: 'absolute', top: '0px', zIndex: '99999999999',width:"35px", paddingTop:"4px", paddingLeft:"4px"}} />}
    //                                   <div
    //                                     onClick={() => {
