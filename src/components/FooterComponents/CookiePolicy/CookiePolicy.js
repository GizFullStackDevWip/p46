            ...
            <div className="menuCloseJS closeMenuWrapper">
                <div className="privacyTermsFlex privacyTermsColor privacyTermsScroll">
                    <div className="privacyTermsWidth">
                        <h6 className="privacyTermsHeading">Cookies Policy</h6>
                        <div className="privacyTermsWrapper">
                            <div className="privacyTermsContent">
                                ...
                                <ul>
                                    ...
                                    <li><strong>Website</strong> refers to HappiTV, accessible from <a href="http://www.gethappi.tv" rel="external nofollow noopener" target="_blank">http://www.gethappi.tv</a></li>
